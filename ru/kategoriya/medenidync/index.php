<?php
	...
	$query=mysqli_query($mysql_con,"SELECT id, name, img, adres, ssyl from medenidync WHERE name like '%".$search."%'");
...
<title>MyhmanaHyzmat - Medeni dynç alyş ýerler</title>
...
<!--  HEADER Begin  -->
<header>
  <div class="jumbotron" style="background-image: url(../../../images/medenidync/0.jpg); background-size: cover; background-position: center">
    <div class="container">
      <div class="row">
        <div class="col-xs-12 text-fon">
          ...
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <h1 class="text-center">Medeni dynç alyş ýerler</h1>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
		...
		<?php
					...
					<div class="col-lg-4 col-sm-12 text-center posts" style="background-color: white">
						<div class="div1"><a href="'.$info["ssyl"].'"><img alt="140x140" src="'.$info["img"].'"></a></div>
							<div class="div2">
								<a href="'.$info["ssyl"].'"><h3>"'.$info["name"].'" seýilgähi</h3></a><hr>
