...
<div id="mainWrapper">
	...
	<div id="content">
			...
			<div id="menubar">
				<nav class="menu">
					...
					<ul>
						...
						<li><img src="../images/icons/dostaw.ico"><a href="kategoriya/eltipbermekhyzmatlary/" title="Eltip bermek hyzmatlary">Eltip bermek hyzmatlary</a></li>
						<li><img src="../images/icons/taxi.ico"><a href="kategoriya/taxi/" title="Taksi">Taksi hyzmaty</a></li>
						<li><img src="../images/icons/awtomenzil.ico"><a href="kategoriya/awtomenzil/" title="Awtomenzil">Halkara awtomenzili</a></li>
						...
						<li><img src="../images/icons/park.ico"><a href="kategoriya/medenidync/" title="Medeni dynç alyş ýerler">Medeni dynç alyş ýerleri</a></li>
			...
			<div class="container">
				<div class="owl-carousel owl-theme blog-post">
					...
					<article class="blog-content">
						...
						<div class="aktaz">
							<p id="ady" style="font-size: 20px"><b>Eltip bermek hyzmatlary</b></p>
					...
					<article class="blog-content">
						...
						<div class="aktaz">
							<p id="ady" style="font-size: 20px"><b>Taksi hyzmaty</b></p>
					...
					<article class="blog-content">
						...
						<div class="aktaz">
							<p id="ady" style="font-size: 20px"><b>Awtomenzili</b></p>
					...
					<article class="blog-content">
						<div class="images"><img alt="10.jpg" src="../images/hyzmatlar/10.jpg"></div>
						<div class="aktaz">
							<p id="ady" style="font-size: 20px"><b>Medeni dynç alyş ýerleri</b></p>
							<a href="kategoriya/medenidync/" class="kategoriya">&nbsp;</a>	
						</div>
					</article>
					<article class="blog-content">
						<div class="images"><img alt="11.jpg" src="../images/hyzmatlar/11.jpg"></div>
						<div class="aktaz">
					...
					<article class="blog-content">
						<div class="images"><img alt="12.jpg" src="../images/hyzmatlar/12.jpg"></div>
						<div class="aktaz">
		...
		<div><a target="_blank" href="https://www.rysgalmebel.com/"><img alt="sample" src="../images/1.gif" style="width: 100%"></a></div>
		<hr>
		<div class="asd" style="background-image: url(../images/2.jpg); background-position: center; background-repeat: no-repeat; background-size: cover">
		<div class="col-md-4 col-md-offset-4" >
				<div class="weather">
						<div class="current">
								<div class="info">
										<div>&nbsp;</div>
										<div class="city">Aşgabat şäherde howa maglumaty</div>
										<div class="temp">12&deg; <small>C</small></div>
										<div class="wind"><small><small>Ýel:</small></small> 22 km/sag</div>
										<div>&nbsp;</div>
								</div>
						</div>
				</div>
