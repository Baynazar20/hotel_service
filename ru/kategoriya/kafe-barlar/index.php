<?php
	...
	$query=mysqli_query($mysql_con,"SELECT id, name, nomer, yerlesyan_yeri, img, abray from kafebar WHERE name like '%".$search."%'");
...
<title>MyhmanaHyzmat - Kafe-barlar</title>
...
<!--  HEADER Begin  -->
<header>
  <div class="jumbotron" style="background-image: url(../../../images/kafebarlar/0.jpg); background-size: cover; background-position: center">
    <div class="container">
      <div class="row">
        <div class="col-xs-12 text-fon">
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <h1 class="text-center">Kafe-Barlar</h1>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
	...
	<div class="container">
		...
		<?php
					...
					<div class="col-lg-4 col-sm-12 text-center posts" style="background-color: white">
						<div class="div1"><a href="kafebars?id='.$info["id"].'"><img alt="140x140" src="'.$info["img"].'"></a></div>
							<div class="div2">
								<a href="kafebars?id='.$info["id"].'"><h3>"'.$info["name"].'" kafe-bary</h3></a><hr>
