<?php
	...
	$id=$_GET["id"];
	$query=mysqli_query($mysql_con,"SELECT * from kafebar where id='$id'");
...
<html lang="en">
	<head>
		...
		<title>MyhmanaHyzmat - Kafe-barlar - menu</title>
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 maglumat">
							<h1 class="text-center">"<?php echo($info['name']); ?>" kafe-bary barada maglumat</h1>
		...
		<section style="position: relative">
			...
			<div class="container">
				<div class="tabbed">
					<?php
						$index="1";
						$query_naw=mysqli_query($mysql_con,"SELECT id,name,full_name,img from kafebar_food_cats");
					...
					<div class="tabs">
						...
						<?php
							$index="1";
							$query_naw=mysqli_query($mysql_con,"SELECT id,name,full_name from kafebar_food_cats");
								
								while($query_naw_info=mysqli_fetch_array($query_naw)){
									$query_naw_count=mysqli_query($mysql_con,"SELECT count('id') as total from menu WHERE name='$info[name]' and category='$query_naw_info[name]' and status='kafebar'");	
									$count_row=mysqli_fetch_assoc($query_naw_count);
				...
				<div class="col-lg-offset-3 col-xs-12 col-lg-6">
					<div class="jumbotron">
						<div class="row text-center">
							...
							<?php
								$query_com=mysqli_query($mysql_con,"SELECT * from koment where rest_id='$id' and status='kafebar'");
