<?php
	...
	$id=$_GET["id"];
	$query=mysqli_query($mysql_con,"SELECT * from dostawka where id='$id'");
...
<html lang="en">
	<head>
		...
		<title>MyhmanaHyzmat - Eltip bermek hyzmaty - menu</title>
			...
			<div class="container-fluid"> 
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown dil">
							<a href="../../../../../../ru/kategoriya/TürkmenTagam/kategoriya/tmekan/aylygozel/" style="padding: 0px; margin: 10px 5px;"><img src="../../../../images/ru.png" style="width: 40px; height: 30px;"></a>
						</li>
						<li class="dropdown dil">
							<a href="../../../../../../en/kategoriya/TürkmenTagam/kategoriya/tmekan/aylygozel/" style="padding: 0px; margin: 10px 5px;"><img src="../../../../images/en.png" style="width: 40px; height: 30px;"></a>
						</li>
					</ul>
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 maglumat">
							<h1 class="text-center">"<?php echo($info['name']); ?>" eltip bermek hyzmaty barada maglumat</h1>
		...
		<section style="position: relative">
			<div style="width: 100%;height: auto;min-height: 300px;display: flex;justify-content: center;align-items: center">
				<div class="add_item_box" style="height: auto;display: flex;align-items: center;justify-content: flex-start;flex-direction: column">
						...
						<p><a href="javascript:PopUpShow2()" class="buttongosmak b-container" style="margin: 10px">Eltip bermek</a></p>
			...
			<div class="container">
				<div class="tabbed">
					<?php
						$index="1";
						$query_naw=mysqli_query($mysql_con,"SELECT id,name,full_name,img from eltipbermek_food_cats");
					...
					<div class="tabs">
						...
						<?php
							$index="1";
							$query_naw=mysqli_query($mysql_con,"SELECT id,name,full_name from eltipbermek_food_cats");
								
								while($query_naw_info=mysqli_fetch_array($query_naw)){
									$query_naw_count=mysqli_query($mysql_con,"SELECT count('id') as total from menu WHERE name='$info[name]' and category='$query_naw_info[name]' and status='eltipbermek'");	
									$count_row=mysqli_fetch_assoc($query_naw_count);
				...
				<div class="col-lg-offset-3 col-xs-12 col-lg-6">
					<div class="jumbotron">
						<div class="row text-center">
							...
							<?php
								$query_com=mysqli_query($mysql_con,"SELECT * from koment where rest_id='$id' and status='eltipbermek'");
