			...
			<div class="container-fluid"> 
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown dil">
								<a href="" style="padding: 0px; margin: 10px 5px;"><img src="../../../../images/en.png" style="width: 40px; height: 30px;"></a>
						</li>
					</ul>
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 maglumat">
							<h1 class="text-center">Information about "<?php echo($info['name']); ?>" restaurant</h1>
								<p class="text-center"><img src="../../../../images/icons/tel.ico"> Phone number: <?php echo($info['nomer']); ?>
									<button id="tel" type="submit" class="btn btn-default">
										<a href="tel:<?php echo($info['jan_ucin_nomer']); ?>"><img src="../../../../images/icons/tel2.ico"> Call</a>
									</button>
								</p>
								<p class="text-center"><img src="../../../../images/icons/yer.ico"> Address: <?php echo($info['yerlesyan_yeri']);?> <button id="yer" type="submit" class="btn btn-default"><a href="<?php echo($info['koordinata']); ?>">Log in</a></button></p>
								<p class="text-center"><img src="../../../../images/icons/sale.ico"> Sale: <?php echo($info['aksiya']); ?></p>
								<p class="text-center"><img src="../../../../images/icons/2.ico"> Rating: <?php $s=0; for ($i=1; $i<=$info['abray']; $i++) echo('<img src="../../../../images/icons/1.ico"> ');?></p>
								<div id="we" data-hidden_menu="true" class="hidden_menu">
									<p class="text-center"><img src="../../../../images/icons/dostaw.ico"> Delivery: <?php echo($info['dostawka']); ?></p>
									...
									<p class="text-center"><img src="../../../../images/icons/caga.ico"> Child zone: <?php echo($info['caga_zona']); ?></p>								
		...
		<section style="position: relative">
			<div style="width: 100%;height: auto;min-height: 300px;display: flex;justify-content: center;align-items: center">
				<div class="add_item_box" style="height: auto;display: flex;align-items: center;justify-content: flex-start;flex-direction: column">
						...
						<a href="javascript:PopUpShow2()" class="buttongosmak b-container" style="margin: 10px">Deliver</a></p>
						<div class="b-popup" id="popup1" style="z-index: 1000000000000">
							<div class="b-popup-content">
								...
								<button style="margin: 10px"><a href="javascript:PopUpHide1()">Cancle</a></button></p>
							</div>
						</div>
						<div class="b-popup" id="popup2" style="z-index: 1000000000000">
							<div class="b-popup-content">
								...
								<p class="text-center"><button style="margin: 10px"><a href="javascript:PopUpHide2(); alert('Siziň sargydyňyz 30-60 minutdan barar! Içdäniň açyk bolsun!')">Deliver</a></button>
								<button style="margin: 10px"><a href="javascript:PopUpHide2()">Cancle</a></button></p>
							</div>
						</div>		
				</div>
			</div>
			...
			<div class="container">
				<div class="tabbed">
					<?php
						$index="1";
						$query_naw=mysqli_query($mysql_con,"SELECT id,name,full_name_en,img from restoran_food_cats");
							while($query_naw_info=mysqli_fetch_array($query_naw)){
								...
								if($count_row['total']>0){
									if($index=="1"){
										...
										<label for="tab-nav-'.$index.'"><img src="'.$query_naw_info['img'].'" style="width: 19px; height: 19px;"> '.$query_naw_info['full_name_en'].' ('.$count_row['total'].')</label>');
									}else{
									...
									if($count_row['total']>0){
										...
										while($info_menu=mysqli_fetch_array($query_menu)){
											...
											<div class="food_list" data-box_id="'.$info_menu["box_id"].'">
												...
												<p>"'.$info_menu["name_en"].'"</p>
												<p class="baha" style="font-size: 25px;">'.$info_menu["price"].' manat</p>
												<p class="text-center">Düzümi: '.$info_menu["duzumi_en"].'</p>
												<button class="buttongosmak" data-btn_id="'.$info_menu["box_id"].'">✚ Add to card</button>
											</div>');
										}
