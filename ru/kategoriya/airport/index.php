...
<title>MyhmanaHyzmat - Airport</title>
...
<!--  HEADER Begin  -->
<header>
  <div class="jumbotron" style="background-image: url(../../../images/airport/0.jpg); background-size: cover; background-position: center">
    <div class="container">
      <div class="row">
        <div class="col-xs-12 text-fon">
          ...
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <h1 class="text-center">Halkara howa menzili</h1>
         	<p class="text-center"><img src="../../../images/icons/tel.ico"> Habarlaşnak üçin telefon belgiler: 23-49-23
						<button id="tel" type="submit" class="btn btn-default">
							<a href="tel:+99312234923"><img src="../../../images/icons/tel2.ico"> Jaň etmek</a>
						</button>
					</p>
				  <p class="text-center"><img src="../../../images/icons/yer.ico"> Salgysy: Aşgabat ş.<button id="yer" type="submit" class="btn btn-default"><a href="https://www.google.com/maps/place/Ashgabat+International+Airport/@37.9845133,58.3665111,15z/data=!4m5!3m4!1s0x0:0xbfb3d0b11ea47c44!8m2!3d37.9845133!4d58.3665111">Görmek</a></button></p>
         	<p class="text-center"><button id="yer" type="submit" class="btn btn-default"><a href="https://ashgabatairport.gov.tm"><img src="../../../images/icons/yer.ico"> Howa menziliniň internet sahypasyna girmek</a></button></p>
         	<p>&nbsp;</p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
