<?php
	...
	$query=mysqli_query($mysql_con,"SELECT id, name, adres, img, ssyl, tel from teatkino WHERE name like '%".$search."%'");
...
<title>MyhmanaHyzmat - Teatrlar we kinokonsert merkezleri</title>
...
<!--  HEADER Begin  -->
<header>
  <div class="jumbotron" style="background-image: url(../../../images/teatkino/0.jpg); background-size: cover; background-position: center">
    <div class="container">
      <div class="row">
        <div class="col-xs-12 text-fon">
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <h1 class="text-center">Teatrlar we kinokonsert merkezleri</h1>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
...
<section style="background-image: url(../../../images/subtlenet2.webp)">
	<div class="row">
		<div class="col-lg-12 page-header text-center">
			<h2>Teatrlar we kinokonsert merkezleri</h2>
		</div>
	</div>
	<div class="container">
		<div class="row">
