...
<title>MyhmanaHyzmat - Taksi</title>
...
<!--  HEADER Begin  -->
<header>
  <div class="jumbotron" style="background-image: url(../../../images/taxi/0.jpg); background-size: cover; background-position: center">
    <div class="container">
      <div class="row">
        <div class="col-xs-12 text-fon">
          ...
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <h1 class="text-center">Taksi hyzmaty</h1>
         	<p class="text-center"><img src="../../../images/icons/tel.ico"> Habarlaşnak üçin telefon belgiler: 76-05-01
				<button id="tel" type="submit" class="btn btn-default">
					<a href="tel:+99312760501"><img src="../../../images/icons/tel2.ico"> Jaň etmek</a>
				</button>
			</p>
			<p>&nbsp;</p>
          <p>&nbsp;</p>
