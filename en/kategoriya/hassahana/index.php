<?php
	...
	$query=mysqli_query($mysql_con,"SELECT id, name, img, adres, ssyl, tel from hospital WHERE name like '%".$search."%'");
...
<title>MyhmanaHyzmat - Halkara we merkezi hassahanalar</title>
	...
	<div class="container-fluid"> 
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav navbar-right">
				<li><a href="#">Biz bilne habarlaşmak</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 text-fon">
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <h1 class="text-center">Halkara we merkezi hassahanalar</h1>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
...
<section style="background-image: url(../../../images/subtlenet2.webp)">
	<div class="row">
		<div class="col-lg-12 page-header text-center">
			<h2>Halkara we merkezi hassahanalar</h2>
		</div>
	</div>
	<div class="container">
		<div class="row">
