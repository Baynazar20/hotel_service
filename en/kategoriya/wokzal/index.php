...
<title>MyhmanaHyzmat - Wokzal</title>
...
<!--  HEADER Begin  -->
<header>
  <div class="jumbotron" style="background-image: url(../../../images/wokzal/0.jpg); background-size: cover; background-position: center">
    <div class="container">
      <div class="row">
        <div class="col-xs-12 text-fon">
          ...
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <h1 class="text-center">Wokzal</h1>
         	<p class="text-center"><img src="../../../images/icons/tel.ico"> Habarlaşnak üçin telefon belgiler: 42-00-00
						<button id="tel" type="submit" class="btn btn-default">
							<a href="tel:+99312420000"><img src="../../../images/icons/tel2.ico"> Jaň etmek</a>
						</button>
					</p>
				  <p class="text-center"><img src="../../../images/icons/yer.ico"> Salgysy: Aşgabat ş. ...<button id="yer" type="submit" class="btn btn-default"><a href="">Görmek</a></button></p>
         	<p class="text-center"><button id="yer" type="submit" class="btn btn-default"><a href=""><img src="../../../images/icons/yer.ico"> Wokzalyň internet sahypasyna girmek</a></button></p>
         	<p>&nbsp;</p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
